...
<head>
	...
	<meta name="description" content="<?= $CONTENT__DATA['PAGE_DESCRIPTION_QUARTER']; ?>">
  <meta name="keywords" content="<?= $CONTENT__DATA['PAGE_KEYWORDS_QUARTER']; ?>">
  <title>
    <?= $CONTENT__DATA['TITLE_HEADER_PLAY_QUARTER'].' | '.$CONTENT__DATA__ALL_PAGE['PAGE_TITLE']; ?>
  </title>
</head>
