...
<head>
	...
	<meta name="description" content="<?= $CONTENT__DATA['PAGE_DESCRIPTION_WEEK']; ?>">
  <meta name="keywords" content="<?= $CONTENT__DATA['PAGE_KEYWORDS_WEEK']; ?>">
  <title>
    <?= $CONTENT__DATA['TITLE_HEADER_PLAY_WEEK'].' | '.$CONTENT__DATA__ALL_PAGE['PAGE_TITLE']; ?>
  </title>
</head>
